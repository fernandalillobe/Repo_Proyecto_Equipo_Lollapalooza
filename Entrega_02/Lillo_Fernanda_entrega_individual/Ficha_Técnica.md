...
* https://www.sonymusic.com.mx/artist/elsa-y-elmar/
* https://electropedia.fandom.com/es/wiki/Alan_Walker
* https://www.chilevision.cl/lollapalooza-chile/quienes-son-the-alive-conoce-todos-los-detalles-de-su-show-en-lollapalooza-2024/
## Metodología de la construcción de la base
Con mi grupo decidimos que para construir la base lo mejor sería dividirnos el trabajo por años, dada la gran cantidad de información que había que recolectar. Por ello, yo estuve a cargo de los años 2022 a 2026. Para agilizar el proceso creamos un archivo de Excel compartido, en el que podíamos editar de manera simultanea en cualquier momento del día. Además, nos pusimos de acuerdo para definir detalles como el si dentro de la sección “integrantes” contaríamos a los músicos de acompañamiento o no, cuántos géneros musicales por artista incluiríamos y cómo sería el conteo de la cantidad de veces que un artista había estado en el festival en el país (había que definir si se contaba todas las veces que un artista ha estado en total en Lollapalooza o si el conteo iría aumentando progresivamente).
## Alcance de los datos
Nuestro alcance de datos se centro en analizar las ediciones, nacionalidades, escenarios y géneros musicales de todos los artistas que se han presentado en Lollapalooza Chile, además de determinar si estos son artistas en solitario o bandas, así como la cantidad de veces que se han presentado en el festival. Por ello, nuestros datos abarcan todos los años de existencia del festival.
...
Según su estado, corresponden a datos procesados, ya que alguien más se encargó de ordenar y publicar la información en las páginas web que visite para darles un formato determinado.

Según su fuente, son datos de fuente abierta, ya que pueden ser buscados, utilizados y redistribuidos por cualquiera persona además de mí, de hecho. Por ejemplo, yo busque datos en Wikipedia, los que reutilice y ordené en mi base de datos, y dado que ese sitio web es de uso público y gratuito, cualquier otra persona podría ir a buscar los mismos datos y utilizarlos para otra cosa.
