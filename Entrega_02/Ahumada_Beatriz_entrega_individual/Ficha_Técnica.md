...
## Fuente de los datos
En el proceso de la construcción de esta base de datos, las fuentes de información pública que se utilizaron fueron la enciclopedia Wikipedia, para recolectar y completar información sobre los artistas, páginas web de noticias respecto al Lollapalooza de cada edición para rectificar información y corroborar si es que sucedía algún reemplazo de artista o escenario (como Rock&Pop, Radio Futuro, AS Chile, entre otros), y otros sitios web dedicados a la música como SunderBeats y Last.fm.  

## Metodología
Al ser una base de datos construida desde cero por el grupo, se definieron  columnas con su respectivo titular y filtro para posteriormente rellenar las filas con la recopilación manual de la información sobre los artistas que participaron en cada edición del festival. Para ello se identificaron y clasificaron todos los artistas por año, variables como el género musical, nacionalidad, integrantes, headliner, escenario donde se presentó y cantidad de veces que se han presentado en el festival hasta la fecha en el país.
...
| Headliner | Artistas principales que encabezan la edición | Cualitativo | Diversidad de artistas |
| Escenario | Nombre del escenario en que se presentó | Cualitativo | Diversidad de escenarios |
| Cantidad de presentaciones | Veces que se presentó el artista en el festival hasta la fecha | Cuantitativo | 1, 2, 3, 4, etc |
