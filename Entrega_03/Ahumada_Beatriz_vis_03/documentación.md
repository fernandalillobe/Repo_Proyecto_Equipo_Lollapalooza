...
Para efectos de este trabajo, se tuvo que completar en su totalidad la base de datos 1, creada desde cero en Excel donde se creó cada columna con su filtro, asignándole un respectivo titular: edición del festival, artista, genero musical 01, genero musical 02, genero musical 03, cantidad de integrantes, nacionalidad, headliner, escenario de presentación y cantidad de veces que se presentó el artista en el festival hasta la fecha. La información se recabo de fuentes abiertas como Wikipedia, sitios web de noticias y sitios web dedicados a la música.
